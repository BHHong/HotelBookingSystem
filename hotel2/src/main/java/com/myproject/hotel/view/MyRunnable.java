...
public class MyRunnable implements Runnable{
	...
	@Override
	public void run() {
//		System.out.println(Thread.currentThread().getName() + " START :"+System.nanoTime()+"ns");
		Date d1, d2, d3, d4;
		try {
			 d1 = new SimpleDateFormat("yyyy-MM-dd").parse("2012-02-10");
			 d2 = new SimpleDateFormat("yyyy-MM-dd").parse("2012-06-15");
			 d3 = new SimpleDateFormat("yyyy-MM-dd").parse("2012-09-20");
			 d4 = new SimpleDateFormat("yyyy-MM-dd").parse("2012-12-30");
...
//		System.out.println(Thread.currentThread().getName() + " END :"+System.nanoTime()+"ns");
	}
}
